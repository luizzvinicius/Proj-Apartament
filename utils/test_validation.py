...
def test_cpf_format_is_ok():
    assert lengh_is_11("9192938290") is False  # 10 numbers
    assert lengh_is_11("919293829078") is False  # 12 numbers
    assert lengh_is_11("-1897548949") is False
    assert lengh_is_11("718.975.489.49") is False
    assert lengh_is_11(" 718.975.489.49 ") is False
    assert lengh_is_11("718.975.489 49") is False
    assert lengh_is_11("718.975.489-49") is True
